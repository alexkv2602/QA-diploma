...
public class DebitCardPage {
    ...
    private final SelenideElement paymentApprovedNotification = $(".notification_status_ok");
    private final SelenideElement paymentDeclinedNotification = $(".notification_status_error");
    ...
    public void paymentDeclined() {
        paymentDeclinedNotification.shouldBe(Condition.visible, Duration.ofSeconds(15));
    }
